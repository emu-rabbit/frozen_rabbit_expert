...
use frozen_rabbit_craft_kernel::{
    GENERIC_BUDGETED_CONDITION_POLICY_VERSION, GENERIC_CAPABILITY_PORTFOLIO_MPC_POLICY_VERSION,
    GENERIC_DEEP_PORTFOLIO_MPC_POLICY_VERSION, GENERIC_DELIVERY_SHIELD_POLICY_VERSION,
    GENERIC_EPISODE_ABI_VERSION, GENERIC_EPISODE_MAX_OUTPUT_BYTES,
    GENERIC_EPISODE_PROTOCOL_VERSION, GENERIC_GUIDE_DIRECT_PROBE_VERSION,
