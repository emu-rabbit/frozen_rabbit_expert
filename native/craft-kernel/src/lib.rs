//! Dependency-free native parity checkpoint for the TypeScript mechanics oracle.
//!
//! `oracle-parity-v0.1` is deliberately not a runtime or search kernel. The
//! TypeScript implementation remains authoritative until broader, step-level
//! shared fixtures prove parity.

#![forbid(unsafe_code)]

/// Version of the deliberately narrow native/TypeScript parity contract.
pub const ORACLE_PARITY_VERSION: &str = "oracle-parity-v0.1";
...
pub fn calculate_base_progress(
    recipe: &RecipeFormulaInput,
    crafter: &CrafterFormulaInput,
) -> f64 {
