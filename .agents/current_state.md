...
- 目前最新研究 checkpoint 是 `generic-craft-route-portfolio-v1.9.0`，等價候選名額研究未改善整體效果，不採用，見 [v1.9 結果](../reports/generic-cosmic-overnight/v190-development/results.md)。v1.3 的完整收尾仍是較好的品質方向；v1.4–v1.9 都沒有取得採用證據。現在只對凍結 v1.3 執行 81000000 新種子確認，成本護欄仍未滿足，尚未交付完整 overnight。四類品質目標分開評分，不讀 recipe／equipment ID；1.x 與 Application／Cargo package／公開發布版本各自管理。
