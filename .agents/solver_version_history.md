...
| v1.11 | `generic-craft-route-portfolio-v1.11.0` | Stable 與 hard-quality 精確保留 v1.1；Balanced／Aggressive 的 optional-quality 目標使用全九球色共同提案與 funded route 比較，Aggressive 非 HQ 的 endgame beam 再用 mechanics 尺度的 CP／耐久／進展 reserve／IQ／buff 資源排序。Selector 只讀 objective、risk、recipe／crafter mechanics 與 state，不讀 ID、seed 或未來 RNG；不增加 beam 預算。 | 完整 overnight 研究基礎。一般收藏品已有明顯可感知品質收益；後續 completion-aware 描述性候選以通用 finish witness 守住 Balanced 完工能力，HQ／Master 使用 v1.1，並已通過 exact-tape 與未見 seed bounded gate。完整確認通過後才建立下一個數字版號。見 [v1.11 bounded 結果](../reports/generic-cosmic-overnight/v111-development/results.md)、[完整四表](../reports/generic-cosmic-overnight/generic-native-v111-checkpoint-vs-v110-history-64seed-20260829.md) 與 [completion-aware review](../reports/generic-cosmic-overnight/v111-completion-aware-bounded-review-20260829.md)。 |
